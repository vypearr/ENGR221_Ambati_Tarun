...
class BoardDisplay:
    ...
    def load_images(self) -> None:
        ...
        try:
            ...
            self.body_img = pygame.image.load(Preferences.BODY_IMAGE)
    ...
    def draw_cell(self, cell: Cell) -> None:
        ...
        elif cell.is_body() and self.body_img:
            self.draw_image(self.body_img, row, col)
    ...
    def display_gameover(self) -> None:
        ...
        text_rect = text.get_rect(center=(Preferences.BOARD_WIDTH / 2, 
                                          Preferences.BOARD_HEIGHT / 2))
        # Place the text on the screen
        self.screen.blit(text, text_rect)